...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attendee.python_exp'
        db.add_column(u'meetups_attendee', 'python_exp',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attendee.python_exp'
        db.delete_column(u'meetups_attendee', 'python_exp')
